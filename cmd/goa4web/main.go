...
import (
	...
	externallinkworker "github.com/arran4/goa4web/workers/externallinkworker"
...
func registerTasks(reg *tasks.Registry, ah *adminhandlers.Handlers) {
	...
	register("externallink", externallinkworker.RegisterTasks())
...
func (r *rootCmd) Usage() {
	_ = executeUsage(r.fs.Output(), "root_usage.txt", r)
}
