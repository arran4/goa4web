...
var StringOptions = []StringOption{
	...
	{"image-cache-mode", EnvImageCacheMode, "Cache retention mode: none, ttl, http, last-used, size, ttl-size, http-size, or last-used-size.", "none", nil, "", func(c *RuntimeConfig) *string { return &c.ImageCacheMode }},
	{"image-cache-ttl", EnvImageCacheTTL, "Time-based cache retention duration such as 24h, 720h, or 8760h.", "720h", nil, "", func(c *RuntimeConfig) *string { return &c.ImageCacheTTL }},
	{"image-cache-fetch-retry-delay", EnvImageCacheFetchRetryDelay, "Delay between remote image cache fetch retries, such as 1m or 30s.", "1m", nil, "", func(c *RuntimeConfig) *string { return &c.ImageCacheFetchRetryDelay }},
	...
	{"image-thumbnail-sizes", EnvImageThumbnailSizes, "Comma-separated thumbnail bounds in height x width form. The first size is generated on upload; the others are generated on demand.", "400x800,800x1600", []string{"400x800,800x1600"}, "", func(c *RuntimeConfig) *string { return &c.ImageThumbnailSizes }},
	{"image-safe-dimensions", EnvImageSafeDimensions, "Comma-separated list of max dimensions for safe image resizing.", "1024x768,800x600", nil, "", func(c *RuntimeConfig) *string { return &c.ImageSafeDimensions }},
...
var IntOptions = []IntOption{
	...
	{"image-thumbnail-size", EnvImageThumbnailSize, "The legacy square fallback size of generated thumbnails.", 0, "", func(c *RuntimeConfig) *int { return &c.ImageThumbnailSize }},
	{"image-max-resize-bytes", EnvImageMaxResizeBytes, "The maximum byte size of an image that triggers resizing in the cache server.", 20971520, "", func(c *RuntimeConfig) *int { return &c.ImageMaxResizeBytes }},
