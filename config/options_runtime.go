...
var StringOptions = []StringOption{
	...
	{"image-thumbnail-sizes", EnvImageThumbnailSizes, "Comma-separated square thumbnail sizes. The first size is generated on upload; the others are generated on demand.", "", []string{"200,400,800"}, "", func(c *RuntimeConfig) *string { return &c.ImageThumbnailSizes }},
...
var IntOptions = []IntOption{
	...
	{"image-thumbnail-size", EnvImageThumbnailSize, "The legacy fallback size (width and height) of generated thumbnails.", DefaultImageThumbnailSize, "", func(c *RuntimeConfig) *int { return &c.ImageThumbnailSize }},
