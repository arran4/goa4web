...
var StringOptions = []StringOption{
	...
	{"link-allowed-hosts", EnvLinkAllowedHosts, "A comma-separated list of allowed hostnames that will not be signed.", "", nil, "", func(c *RuntimeConfig) *string { return &c.LinkAllowedHosts }},
