...
var StringOptions = []StringOption{
	...
	{"jmap-account", EnvJMAPAccount, "The account to use for the JMAP server.", "", nil, "", func(c *RuntimeConfig) *string { return &c.EmailJMAPAccount }},
	{"jmap-identity", EnvJMAPIdentity, "The identity to use for the JMAP server.", "", nil, "", func(c *RuntimeConfig) *string { return &c.EmailJMAPIdentity }},
