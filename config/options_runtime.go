...
var StringOptions = []StringOption{
	...
	{"image-sign-expiry", EnvImageSignExpiry, "The default expiry duration for image URLs.", "", nil, "", func(c *RuntimeConfig) *string { return &c.ImageSignExpiry }},
	...
	{"link-sign-expiry", EnvLinkSignExpiry, "The default expiry duration for external link URLs.", "", nil, "", func(c *RuntimeConfig) *string { return &c.LinkSignExpiry }},
	...
	{"share-sign-expiry", EnvShareSignExpiry, "The default expiry duration for share URLs.", "", nil, "", func(c *RuntimeConfig) *string { return &c.ShareSignExpiry }},
