...
func TestLatestNewsRespectsPermissions(t *testing.T) {
	...
	mock.ExpectQuery("SELECT 1 FROM grants").WithArgs(int32(1), "news", sql.NullString{String: "post", Valid: true}, "see", sql.NullInt32{Int32: 2, Valid: true}, false, sql.NullInt32{Int32: 1, Valid: true}, false).WillReturnError(sql.ErrNoRows)
