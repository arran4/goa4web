...
var GrantActionMap = map[string]GrantDefinition{
	...
	"forum|topic":                {Actions: []string{"see", "view", "reply", "post", "edit", "edit-any", "append"}, RequireItemID: true},
	...
	"privateforum_thread|thread": {Actions: []string{"view", "reply", "append", "edit", "edit-any"}, RequireItemID: true},
