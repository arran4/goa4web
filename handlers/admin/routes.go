...
func (h *Handlers) RegisterRoutes(ar *mux.Router, _ *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	ar.HandleFunc("/user/{id}/blogs", adminUserBlogsPage).Methods("GET")
	ar.HandleFunc("/user/{id}/writings", adminUserWritingsPage).Methods("GET")
	...
	ar.HandleFunc("/role/{id}/grant/update", handlers.TaskHandler(roleGrantUpdateTask)).Methods("POST").MatcherFunc(roleGrantUpdateTask.Matcher())
	...
	ar.HandleFunc("/comment/{id}", adminCommentPage).Methods("GET")
	ar.HandleFunc("/comment/{id}", handlers.TaskHandler(editCommentTask)).Methods("POST").MatcherFunc(editCommentTask.Matcher())
	ar.HandleFunc("/comment/{id}", handlers.TaskHandler(deleteCommentTask)).Methods("POST").MatcherFunc(deleteCommentTask.Matcher())
	ar.HandleFunc("/comment/{id}", handlers.TaskHandler(banCommentTask)).Methods("POST").MatcherFunc(banCommentTask.Matcher())
