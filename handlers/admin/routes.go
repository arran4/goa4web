...
func (h *Handlers) RegisterRoutes(ar *mux.Router, cfg *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	ar.HandleFunc("", handlers.PageHandler(&AdminPage{})).Methods("GET")
	ar.HandleFunc("/", handlers.PageHandler(&AdminPage{})).Methods("GET")
	...
	ar.HandleFunc("/roles", handlers.PageHandler(&AdminRolesPage{})).Methods("GET")
	ar.HandleFunc("/roles/load", handlers.PageHandler(&AdminRoleLoadPage{DBPool: h.DBPool})).Methods("GET", "POST")
	ar.HandleFunc("/roles/templates", handlers.PageHandler(&AdminRoleTemplatesPage{})).Methods("GET")
	...
	ar.HandleFunc("/external-links", handlers.PageHandler(&AdminExternalLinksPage{})).Methods("GET")
	...
	ar.HandleFunc("/external-links/{id}", handlers.TaskHandler(&AdminExternalLinkDetailsTask{})).Methods("GET")
	...
	ar.HandleFunc("/db/status", handlers.PageHandler(&AdminDBStatusPage{DBPool: h.DBPool})).Methods("GET")
	ar.HandleFunc("/db/schema", handlers.PageHandler(&AdminDBSchemaPage{})).Methods("GET")
	ar.HandleFunc("/db/migrations", handlers.PageHandler(&AdminDBMigrationsPage{})).Methods("GET")
	...
	ar.HandleFunc("/links/tools", handlers.PageHandler(&AdminLinksToolsPage{})).Methods("GET", "POST")
	ar.HandleFunc("/link-remap", handlers.PageHandler(&AdminLinkRemapPage{})).Methods("GET")
	ar.HandleFunc("/link-remap", handlers.TaskHandler(applyLinkRemapTask)).Methods("POST").MatcherFunc(applyLinkRemapTask.Matcher())
	ar.HandleFunc("/db/backup", handlers.PageHandler(&AdminDBBackupPage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	...
	ar.HandleFunc("/db/restore", handlers.PageHandler(&AdminDBRestorePage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	...
	ar.HandleFunc("/email/queue", handlers.PageHandler(&AdminEmailPage{})).Methods("GET")
	ar.HandleFunc("/email/failed", handlers.PageHandler(&AdminEmailPage{})).Methods("GET")
	ar.HandleFunc("/email/sent", handlers.PageHandler(&AdminEmailPage{})).Methods("GET")
	...
	ar.HandleFunc("/email/test", handlers.PageHandler(&AdminEmailTestPage{})).Methods("GET", "POST")
	...
	ar.HandleFunc("/email/template", handlers.PageHandler(&AdminEmailTemplatePage{})).Methods("GET")
	...
	ar.HandleFunc("/templates/export", handlers.PageHandler(&AdminTemplateExportPage{})).Methods("GET")
	...
	ar.HandleFunc("/dlq", handlers.PageHandler(&AdminDLQPage{})).Methods("GET")
	ar.HandleFunc("/dlq/{provider}/{id}", handlers.PageHandler(&AdminDLQDetailsPage{})).Methods("GET")
	...
	ar.HandleFunc("/notifications", handlers.PageHandler(&AdminNotificationsPage{})).Methods("GET")
	...
	ar.HandleFunc("/subscriptions/templates", handlers.PageHandler(&AdminSubscriptionTemplatesPage{})).Methods("GET")
	ar.HandleFunc("/subscriptions/templates", handlers.PageHandler(&AdminSubscriptionTemplatesPage{})).Methods("POST").MatcherFunc(tasks.HasNoTask())
	...
	ar.HandleFunc("/requests", handlers.PageHandler(&AdminRequestQueuePage{})).Methods("GET")
	ar.HandleFunc("/requests/archive", handlers.PageHandler(&AdminRequestArchivePage{})).Methods("GET")
	ar.HandleFunc("/request/{request}", handlers.TaskHandler(&AdminRequestTask{})).Methods("GET")
	...
	ar.HandleFunc("/password_resets", handlers.PageHandler(&AdminPasswordResetListPage{})).Methods("GET", "POST")
	ar.HandleFunc("/user", handlers.PageHandler(&AdminUserListPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}", handlers.TaskHandler(&AdminUserProfileTask{})).Methods("GET")
	...
	ar.HandleFunc("/user/{user}/blogs", handlers.PageHandler(&AdminUserBlogsPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/writings", handlers.PageHandler(&AdminUserWritingsPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/linker", handlers.PageHandler(&AdminUserLinkerPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/imagebbs", handlers.PageHandler(&AdminUserImagebbsPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/forum", handlers.PageHandler(&AdminUserForumPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/comments", handlers.PageHandler(&AdminUserCommentsPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/subscriptions", handlers.PageHandler(&AdminUserSubscriptionsPage{})).Methods("GET")
	...
	ar.HandleFunc("/user/{user}/grants", handlers.PageHandler(&AdminUserGrantsPage{})).Methods("GET")
	ar.HandleFunc("/user/{user}/grant/add", handlers.PageHandler(&AdminUserGrantAddPage{})).Methods("GET")
	...
	ar.HandleFunc("/role/{role}", handlers.TaskHandler(&AdminRoleTask{})).Methods("GET")
	ar.HandleFunc("/role/{role}/edit", handlers.PageHandler(&AdminRoleEditFormPage{})).Methods("GET")
	ar.HandleFunc("/role/{role}/edit", adminRoleEditSavePage).Methods("POST")
	ar.HandleFunc("/role/{role}/grant/add", handlers.PageHandler(&AdminRoleGrantAddPage{})).Methods("GET")
	...
	ar.HandleFunc("/maintenance", handlers.PageHandler(&AdminMaintenancePage{})).Methods("GET")
	...
	ar.HandleFunc("/grant/add", handlers.PageHandler(&AdminGrantAddPage{})).Methods("GET")
	...
	ar.HandleFunc("/user/{user}/reset", handlers.PageHandler(&AdminUserResetPasswordConfirmPage{})).Methods("GET")
	...
	ar.HandleFunc("/comments", handlers.PageHandler(&AdminCommentsPage{})).Methods("GET")
	ar.HandleFunc("/comments/deactivated", handlers.PageHandler(&AdminDeactivatedCommentsPage{})).Methods("GET")
	ar.HandleFunc("/comment/{comment}", handlers.TaskHandler(&AdminCommentTask{})).Methods("GET")
	...
	ar.HandleFunc("/ipbans", handlers.PageHandler(&AdminIPBanPage{})).Methods("GET")
	...
	ar.HandleFunc("/audit", handlers.PageHandler(&AdminAuditLogPage{})).Methods("GET")
	ar.HandleFunc("/settings", handlers.PageHandler(&AdminSiteSettingsPage{ConfigFile: h.ConfigFile})).Methods("GET", "POST")
	ar.HandleFunc("/config/as-cli", handlers.PageHandler(&AdminConfigAsCLIPage{ConfigFile: h.ConfigFile})).Methods("GET")
	ar.HandleFunc("/config/explain", handlers.PageHandler(&AdminConfigExplainPage{ConfigFile: h.ConfigFile})).Methods("GET")
	ar.HandleFunc("/page-size", handlers.PageHandler(&AdminPageSizePage{})).Methods("GET", "POST")
	ar.HandleFunc("/files", handlers.PageHandler(&AdminFilesPage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	ar.HandleFunc("/files/unmanaged", handlers.PageHandler(&AdminUnmanagedFilesPage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	...
	ar.HandleFunc("/images/cache", handlers.PageHandler(&AdminImageCachePage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	...
	ar.HandleFunc("/images/cache/{id}", handlers.PageHandler(&AdminImageCacheDetailsPage{})).Methods("GET").MatcherFunc(handlers.RequiredAccess("administrator"))
	...
	ar.HandleFunc("/share/tools", handlers.PageHandler(&AdminShareToolsPage{})).Methods("GET", "POST")
	ar.HandleFunc("/stats", handlers.PageHandler(&AdminServerStatsPage{Srv: h.Srv, ConfigFile: h.ConfigFile})).Methods("GET")
	ar.HandleFunc("/usage", handlers.PageHandler(&AdminUsageStatsPage{})).Methods("GET")
	...
	ar.HandleFunc("/reload",
		handlers.RequireRole(handlers.PageHandler(&AdminReloadConfigPage{ConfigFile: h.ConfigFile, Srv: h.Srv, DBPool: h.DBPool}), fmt.Errorf("administrator role required"), "administrator")).
		Methods("POST").
