...
func getAdminNavLinks() []navpkg.RouterOptions {
	return []navpkg.RouterOptions{
...
func (h *Handlers) registerRoleAndGrantRoutes(ar *mux.Router, cfg *config.RuntimeConfig) {
...
func (h *Handlers) registerSystemRoutes(ar *mux.Router) {
...
func (h *Handlers) registerCommunicationRoutes(ar *mux.Router) {
...
func (h *Handlers) registerUserManagementRoutes(ar *mux.Router) {
...
func (h *Handlers) registerContentRoutes(ar *mux.Router) {
...
func (h *Handlers) RegisterRoutes(ar *mux.Router, cfg *config.RuntimeConfig) []navpkg.RouterOptions {
	...
	opts := getAdminNavLinks()

	ar.HandleFunc("", AdminPage).Methods("GET")
	ar.HandleFunc("/", AdminPage).Methods("GET")

	h.registerRoleAndGrantRoutes(ar, cfg)
	h.registerSystemRoutes(ar)
	h.registerCommunicationRoutes(ar)
	h.registerUserManagementRoutes(ar)
	h.registerContentRoutes(ar)
