...
func (h *Handlers) RegisterRoutes(ar *mux.Router, cfg *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	navReg.RegisterAdminControlCenter([]string{"Core", "Roles"}, "Roles", "/admin/roles", 25)
	navReg.RegisterAdminControlCenter([]string{"Core", "Roles"}, "Role SQL Loader", "/admin/roles/load", 26)
	navReg.RegisterAdminControlCenter([]string{"Core", "Roles"}, "Role Templates", "/admin/roles/templates", 26)
	navReg.RegisterAdminControlCenter([]string{"Core", "Grants"}, "Grants", "/admin/grants", 27)
	navReg.RegisterAdminControlCenter([]string{"Core", "Grants"}, "Available Grants", "/admin/grants/available", 28)
	navReg.RegisterAdminControlCenter([]string{"Core", "Maintenance"}, "Once Off & Maintenance", "/admin/maintenance", 29)
	navReg.RegisterAdminControlCenter([]string{"Core", "Maintenance"}, "External Links", "/admin/external-links", 30)
	navReg.RegisterAdminControlCenter([]string{"Core", "DB"}, "DB Status", "/admin/db/status", 31)
	navReg.RegisterAdminControlCenter([]string{"Core", "Maintenance"}, "Link Tools", "/admin/links/tools", 31)
	navReg.RegisterAdminControlCenter([]string{"Core", "Maintenance"}, "Link Remap", "/admin/link-remap", 32)
	navReg.RegisterAdminControlCenter([]string{"Core", "Notifications"}, "Notifications", "/admin/notifications", 90)
	navReg.RegisterAdminControlCenter([]string{"Core", "Notifications"}, "Subscription Templates", "/admin/subscriptions/templates", 95)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Queued Emails", "/admin/email/queue", 110)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Failed Emails", "/admin/email/failed", 112)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Sent Emails", "/admin/email/sent", 115)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Email Tester", "/admin/email/test", 118)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Email Template", "/admin/email/template", 120)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Template Export", "/admin/templates/export", 121)
	navReg.RegisterAdminControlCenter([]string{"Core", "Email"}, "Dead Letter Queue", "/admin/dlq", 130)
	navReg.RegisterAdminControlCenter([]string{"Core", "Stats"}, "Server Stats", "/admin/stats", 140)
	navReg.RegisterAdminControlCenter([]string{"Core", "Users"}, "Requests", "/admin/requests", 145)
	navReg.RegisterAdminControlCenter([]string{"Core", "Users"}, "Password Resets", "/admin/password_resets", 146)
	navReg.RegisterAdminControlCenter([]string{"Core", "Users"}, "Comments", "/admin/comments", 147)
	navReg.RegisterAdminControlCenter([]string{"Core", "Users"}, "Deactivated Comments", "/admin/comments/deactivated", 148)
	navReg.RegisterAdminControlCenter([]string{"Core", "Settings"}, "Site Settings", "/admin/settings", 150)
	navReg.RegisterAdminControlCenter([]string{"Core", "Settings"}, "Config Export", "/admin/config/as-cli", 151)
	navReg.RegisterAdminControlCenter([]string{"Core", "Settings"}, "Config Explain", "/admin/config/explain", 151)
	navReg.RegisterAdminControlCenter([]string{"Core", "Settings"}, "Pagination", "/admin/page-size", 152)
	navReg.RegisterAdminControlCenter([]string{"Core", "Files"}, "Files", "/admin/files", 153)
	navReg.RegisterAdminControlCenter([]string{"Core", "Files"}, "Image Cache", "/admin/images/cache", 154)
	navReg.RegisterAdminControlCenter([]string{"Core", "DB"}, "DB Backup", "/admin/db/backup", 154)
	navReg.RegisterAdminControlCenter([]string{"Core", "DB"}, "DB Restore", "/admin/db/restore", 155)
	navReg.RegisterAdminControlCenter([]string{"Core", "Settings"}, "Share Tools", "/admin/share/tools", 155)
	navReg.RegisterAdminControlCenter([]string{"Core", "Stats"}, "Usage Stats", "/admin/usage", 160)
