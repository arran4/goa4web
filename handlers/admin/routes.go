...
func (h *Handlers) RegisterRoutes(ar *mux.Router, cfg *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	ar.HandleFunc("", handlers.TaskHandler(&AdminPage{})).Methods("GET")
	ar.HandleFunc("/", handlers.TaskHandler(&AdminPage{})).Methods("GET")
	...
	ar.HandleFunc("/roles", handlers.TaskHandler(&AdminRolesPage{})).Methods("GET")
	...
	ar.HandleFunc("/external-links", handlers.TaskHandler(&AdminExternalLinksPage{})).Methods("GET")
	...
	ar.HandleFunc("/email/queue", handlers.TaskHandler(&AdminEmailPage{})).Methods("GET")
	ar.HandleFunc("/email/failed", handlers.TaskHandler(&AdminEmailPage{})).Methods("GET")
	ar.HandleFunc("/email/sent", handlers.TaskHandler(&AdminEmailPage{})).Methods("GET")
	...
	ar.HandleFunc("/user", handlers.TaskHandler(&AdminUserListPage{})).Methods("GET")
	...
	ar.HandleFunc("/settings", handlers.TaskHandler(&AdminSiteSettingsPage{ConfigFile: h.ConfigFile})).Methods("GET", "POST")
