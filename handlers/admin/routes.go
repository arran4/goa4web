...
func (h *Handlers) RegisterRoutes(ar *mux.Router, cfg *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	navReg.RegisterAdminControlCenter("Roles", "/admin/roles", 25, "Core", "Roles")
	navReg.RegisterAdminControlCenter("Role SQL Loader", "/admin/roles/load", 26, "Core", "Roles")
	navReg.RegisterAdminControlCenter("Role Templates", "/admin/roles/templates", 26, "Core", "Roles")
	navReg.RegisterAdminControlCenter("Grants", "/admin/grants", 27, "Core", "Grants")
	navReg.RegisterAdminControlCenter("Available Grants", "/admin/grants/available", 28, "Core", "Grants")
	navReg.RegisterAdminControlCenter("Once Off & Maintenance", "/admin/maintenance", 29, "Core", "Maintenance")
	navReg.RegisterAdminControlCenter("External Links", "/admin/external-links", 30, "Core", "Maintenance")
	navReg.RegisterAdminControlCenter("DB Status", "/admin/db/status", 31, "Core", "DB")
	navReg.RegisterAdminControlCenter("Link Tools", "/admin/links/tools", 31, "Core", "Maintenance")
	navReg.RegisterAdminControlCenter("Link Remap", "/admin/link-remap", 32, "Core", "Maintenance")
	navReg.RegisterAdminControlCenter("Notifications", "/admin/notifications", 90, "Core", "Notifications")
	navReg.RegisterAdminControlCenter("Subscription Templates", "/admin/subscriptions/templates", 95, "Core", "Notifications")
	navReg.RegisterAdminControlCenter("Queued Emails", "/admin/email/queue", 110, "Core", "Email")
	navReg.RegisterAdminControlCenter("Failed Emails", "/admin/email/failed", 112, "Core", "Email")
	navReg.RegisterAdminControlCenter("Sent Emails", "/admin/email/sent", 115, "Core", "Email")
	navReg.RegisterAdminControlCenter("Email Tester", "/admin/email/test", 118, "Core", "Email")
	navReg.RegisterAdminControlCenter("Email Template", "/admin/email/template", 120, "Core", "Email")
	navReg.RegisterAdminControlCenter("Template Export", "/admin/templates/export", 121, "Core", "Email")
	navReg.RegisterAdminControlCenter("Dead Letter Queue", "/admin/dlq", 130, "Core", "Email")
	navReg.RegisterAdminControlCenter("Server Stats", "/admin/stats", 140, "Core", "Stats")
	navReg.RegisterAdminControlCenter("Requests", "/admin/requests", 145, "Core", "Users")
	navReg.RegisterAdminControlCenter("Password Resets", "/admin/password_resets", 146, "Core", "Users")
	navReg.RegisterAdminControlCenter("Comments", "/admin/comments", 147, "Core", "Users")
	navReg.RegisterAdminControlCenter("Deactivated Comments", "/admin/comments/deactivated", 148, "Core", "Users")
	navReg.RegisterAdminControlCenter("Site Settings", "/admin/settings", 150, "Core", "Settings")
	navReg.RegisterAdminControlCenter("Config Export", "/admin/config/as-cli", 151, "Core", "Settings")
	navReg.RegisterAdminControlCenter("Config Explain", "/admin/config/explain", 151, "Core", "Settings")
	navReg.RegisterAdminControlCenter("Pagination", "/admin/page-size", 152, "Core", "Settings")
	navReg.RegisterAdminControlCenter("Files", "/admin/files", 153, "Core", "Files")
	navReg.RegisterAdminControlCenter("Image Cache", "/admin/images/cache", 154, "Core", "Files")
	navReg.RegisterAdminControlCenter("DB Backup", "/admin/db/backup", 154, "Core", "DB")
	navReg.RegisterAdminControlCenter("DB Restore", "/admin/db/restore", 155, "Core", "DB")
	navReg.RegisterAdminControlCenter("Share Tools", "/admin/share/tools", 155, "Core", "Settings")
	navReg.RegisterAdminControlCenter("Usage Stats", "/admin/usage", 160, "Core", "Stats")
