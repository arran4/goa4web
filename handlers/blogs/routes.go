...
func RegisterRoutes(r *mux.Router) {
	...
	br.Handle("/blog/{blog}/edit", RequireBlogAuthor(EditBlogTask.Page())).Methods("GET").MatcherFunc(auth.RequiredAccess("writer", "administrator"))
	br.Handle("/blog/{blog}/edit", RequireBlogAuthor(EditBlogTask.Action())).Methods("POST").MatcherFunc(auth.RequiredAccess("writer", "administrator")).MatcherFunc(EditBlogTask.Match)
