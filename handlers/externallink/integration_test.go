...
func TestMigratedExternalLinkLookupAgreement(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			rawTrackedURL:     "https://example.com/redir1?redirect=https://target.test/path?utm_source=x",
			migratedStoredURL: "https://example.com/redir1?redirect=https://target.test/path?utm_source=x",
			id:                319,
			title:             "Redirect 1",
			desc:              "Redirect Description 1",
		},
		{
			name:              "Nested ? in functional query value preserved while outer tracker is removed",
			rawTrackedURL:     "https://example.com/redir2?redirect=https://target.test/path?utm_source=x&gclid=real",
			migratedStoredURL: "https://example.com/redir2?redirect=https://target.test/path?utm_source=x",
			id:                320,
			title:             "Redirect 2",
			desc:              "Redirect Description 2",
		},
		{
			name:              "? in fragment is preserved without outer query",
			rawTrackedURL:     "https://example.com/frag1#section?utm_source=x",
			migratedStoredURL: "https://example.com/frag1#section?utm_source=x",
			id:                321,
			title:             "Fragment 1",
			desc:              "Fragment Description 1",
		},
		{
			name:              "? in fragment is preserved while outer tracker is removed",
			rawTrackedURL:     "https://example.com/frag2?id=1&utm_source=x#section?gclid=fragment",
			migratedStoredURL: "https://example.com/frag2?id=1#section?gclid=fragment",
			id:                322,
			title:             "Fragment 2",
			desc:              "Fragment Description 2",
		},
		{
			name:              "&tracking in fragment is preserved without being cleaned",
			rawTrackedURL:     "https://example.com/frag3?id=1#section&utm_source=x",
			migratedStoredURL: "https://example.com/frag3?id=1#section&utm_source=x",
			id:                323,
			title:             "Fragment 3",
			desc:              "Fragment Description 3",
		},
		{
			name:              "Signature-looking fragment does not prevent outer tracker removal",
			rawTrackedURL:     "https://example.com/frag4?utm_source=x#section&signature=not-query",
			migratedStoredURL: "https://example.com/frag4#section&signature=not-query",
			id:                324,
			title:             "Fragment 4",
			desc:              "Fragment Description 4",
		},
		{
			name:              "Empty host https://?utm_source=x is left untouched",
			rawTrackedURL:     "https://?utm_source=x",
			migratedStoredURL: "https://?utm_source=x",
			id:                325,
			title:             "Empty Host 1",
			desc:              "Empty Host Description 1",
		},
		{
			name:              "Empty host https:///path?utm_source=x is left untouched",
			rawTrackedURL:     "https:///path?utm_source=x",
			migratedStoredURL: "https:///path?utm_source=x",
			id:                326,
			title:             "Empty Host 2",
			desc:              "Empty Host Description 2",
		},
		{
			name:              "Tracking-looking path component is preserved intact",
			rawTrackedURL:     "https://example.com/file1&gclid=part?download=1",
			migratedStoredURL: "https://example.com/file1&gclid=part?download=1",
			id:                327,
			title:             "Path Tracker 1",
			desc:              "Path Tracker Description 1",
		},
		{
			name:              "Tracking-looking path component preserved while outer tracker is removed",
			rawTrackedURL:     "https://example.com/file2&gclid=part?download=1&utm_source=x",
			migratedStoredURL: "https://example.com/file2&gclid=part?download=1",
			id:                328,
			title:             "Path Tracker 2",
			desc:              "Path Tracker Description 2",
		},
		{
			name:              "Signature-looking text nested in functional query value does not prevent outer tracker removal",
			rawTrackedURL:     "https://example.com/redir3?redirect=https://target.test/file?signature=abc&utm_source=x",
			migratedStoredURL: "https://example.com/redir3?redirect=https://target.test/file?signature=abc",
			id:                329,
			title:             "Nested Signature",
			desc:              "Nested Signature Description",
		},
		{
