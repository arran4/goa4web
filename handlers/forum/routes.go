...
func RegisterRoutes(r *mux.Router, cfg *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	navReg.RegisterAdminControlCenter("Forum", "/admin/forum", SectionWeight, "Forum")
	navReg.RegisterAdminControlCenter("Flagged Posts", "/admin/forum/flagged", SectionWeight+1, "Forum")
	navReg.RegisterAdminControlCenter("Moderator Logs", "/admin/forum/logs", SectionWeight+2, "Forum")
	navReg.RegisterAdminControlCenter("Word List", "/admin/forum/list", SectionWeight+3, "Forum")
	navReg.RegisterAdminControlCenter("Categories", "/admin/forum/categories", SectionWeight+4, "Forum")
	navReg.RegisterAdminControlCenter("Topics", "/admin/forum/topics", SectionWeight+5, "Forum")
	navReg.RegisterAdminControlCenter("Threads", "/admin/forum/threads", SectionWeight+6, "Forum")
