...
func RegisterRoutes(r *mux.Router) {
	...
	fr.HandleFunc("/topic/{topic}/thread", ThreadNewActionPage).Methods("POST").MatcherFunc(CreateThreadTask.Match)
	...
	fr.Handle("/topic/{topic}/thread/{thread}/reply", RequireThreadAndTopic(http.HandlerFunc(TopicThreadReplyPage))).Methods("POST").MatcherFunc(ReplyTask.Match)
