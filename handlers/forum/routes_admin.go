...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	far.HandleFunc("/category/{category}", AdminCategoryEditSubmit).Methods("POST").MatcherFunc(categoryChangeTask.Matcher())
	far.HandleFunc("/category/{category}/edit", AdminCategoryEditSubmit).Methods("POST").MatcherFunc(categoryChangeTask.Matcher())
