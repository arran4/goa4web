...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	far.HandleFunc("/categories/category/{category}/edit", AdminCategoryEditPage).Methods("POST").MatcherFunc(categoryChangeTask.Matcher())
	far.HandleFunc("/categories/create", AdminCategoryCreatePage).Methods("GET")
	far.HandleFunc("/categories/create", AdminCategoryCreatePage).Methods("POST").MatcherFunc(categoryCreateTask.Matcher())
