...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	far.HandleFunc("/category/{category}/edit", AdminCategoryEditPage).Methods("GET")
	far.HandleFunc("/categories", handlers.TaskDoneAutoRefreshPage).Methods("POST")
	far.HandleFunc("/category/{category}/edit", AdminCategoryEditPost).Methods("POST").MatcherFunc(categoryChangeTask.Matcher())
	far.HandleFunc("/category", AdminCategoryCreatePage).Methods("POST").MatcherFunc(categoryCreateTask.Matcher())
	far.HandleFunc("/category/{category}/delete", AdminCategoryDeletePage).Methods("POST").MatcherFunc(deleteCategoryTask.Matcher())
