...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	far.HandleFunc("/categories/new", AdminCategoryCreatePage).Methods("GET")
	far.HandleFunc("/categories", AdminCategoryCreateSubmit).Methods("POST").MatcherFunc(categoryCreateTask.Matcher())
