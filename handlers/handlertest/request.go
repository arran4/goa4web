...
func NewCoreData(t *testing.T, ctx context.Context, opts ...common.CoreOption) (*common.CoreData, *db.QuerierStub) {
	t.Helper()
...
func RequestWithCoreData(t *testing.T, req *http.Request, opts ...common.CoreOption) (*http.Request, *common.CoreData, *db.QuerierStub) {
	t.Helper()
	cd, stub := NewCoreData(t, req.Context(), opts...)
	cd.LoadSelectionsFromRequest(req)
	ctx := context.WithValue(req.Context(), consts.KeyCoreData, cd)
	return req.WithContext(ctx), cd, stub
}
