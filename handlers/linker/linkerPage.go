...
func CustomLinkerIndex(data *common.CoreData, r *http.Request) {
	...
	if r.URL.Path == "/linker" || strings.HasPrefix(r.URL.Path, "/linker/category/") {
		...
		data.CustomIndexItems = append(data.CustomIndexItems,
			common.IndexItem{Name: "Linker Atom Feed", Icon: "⚛️", Link: data.AtomFeedURL, GroupID: "advanced"},
			common.IndexItem{Name: "Linker RSS Feed", Icon: "📡", Link: data.RSSFeedURL, GroupID: "advanced"},
		)
	}
}
