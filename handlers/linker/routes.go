...
func RegisterRoutes(r *mux.Router, _ *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	lr.Handle("/comments/{link}", RequireLinkViewOrReply(http.HandlerFunc(CommentsPage))).Methods("GET")
	...
	lr.Handle("/show/{link}", RequireLinkAccess(http.HandlerFunc(ShowPage))).Methods("GET")
