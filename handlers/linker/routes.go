...
func RegisterRoutes(r *mux.Router, _ *config.RuntimeConfig, navReg *navpkg.Registry) {
	...
	lr.HandleFunc("/comments/{link}", handlers.EnforceGrant(CommentsPage, "linker", "link", "view", "link")).Methods("GET")
	lr.HandleFunc("/comments/{link}", handlers.EnforceGrant(handlers.TaskHandler(replyTaskEvent), "linker", "link", "view", "link")).Methods("POST").MatcherFunc(replyTaskEvent.Matcher())
	...
	lr.HandleFunc("/show/{link}", handlers.EnforceGrant(ShowPage, "linker", "link", "view", "link")).Methods("GET")
