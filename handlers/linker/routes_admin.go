...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	lar.HandleFunc("/users/permissions", AdminUserLevelsPage).Methods("GET")
	lar.HandleFunc("/users/permissions", tasks.Action(UserAllowTask)).Methods("POST").MatcherFunc(UserAllowTask.Matcher())
	lar.HandleFunc("/users/permissions", tasks.Action(UserDisallowTask)).Methods("POST").MatcherFunc(UserDisallowTask.Matcher())
}
