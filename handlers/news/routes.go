...
func RegisterRoutes(r *mux.Router) {
	...
	nr.HandleFunc("/news/{post}", EditTask.Action()).Methods("POST").MatcherFunc(auth.RequiredAccess("writer", "administrator")).MatcherFunc(EditTask.Match)
	nr.HandleFunc("/news/{post}", NewPostTask.Action()).Methods("POST").MatcherFunc(auth.RequiredAccess("writer", "administrator")).MatcherFunc(NewPostTask.Match)
