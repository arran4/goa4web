...
func RegisterRoutes(r *mux.Router, _ *config.RuntimeConfig) []navpkg.RouterOptions {
	...
	nr.Handle("/news/{news}/edit", EnforceNewsPostAccess(http.HandlerFunc(handlers.TaskHandler(editTask)))).Methods("POST").MatcherFunc(editTask.Matcher())
	...
	nr.Handle("/news/{news}", EnforceNewsPostAccess(http.HandlerFunc(handlers.TaskHandler(editTask)))).Methods("POST").MatcherFunc(editTask.Matcher())
	...
	nr.Handle("/news/{news}/announcement", promoteAnnouncementGrant(http.HandlerFunc(handlers.TaskHandler(announcementAddTask)))).Methods("POST").MatcherFunc(announcementAddTask.Matcher())
	nr.Handle("/news/{news}/announcement", demoteAnnouncementGrant(http.HandlerFunc(handlers.TaskHandler(announcementDeleteTask)))).Methods("POST").MatcherFunc(announcementDeleteTask.Matcher())
