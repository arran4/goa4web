...
func RegisterAdminRoutes(ar *mux.Router, navReg *navpkg.Registry) {
	navReg.RegisterAdminControlCenter("Pending Users", "/admin/users/pending", SectionWeight-5, "Users")
	navReg.RegisterAdminControlCenter("Users", "/admin/users", SectionWeight, "Users")
