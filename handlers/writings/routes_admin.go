...
func RegisterAdminRoutes(ar *mux.Router) {
	...
	war.HandleFunc("/category/{category}/permissions", CategoryPermissionsPage).Methods("GET")
	war.HandleFunc("/category/{category}/permissions", CategoryPermissionsAllowPage).Methods("POST").MatcherFunc(hcommon.TaskMatcher(hcommon.TaskUserAllow))
	war.HandleFunc("/category/{category}/permissions/delete", CategoryPermissionsDisallowPage).Methods("POST").MatcherFunc(hcommon.TaskMatcher(hcommon.TaskUserDisallow))
