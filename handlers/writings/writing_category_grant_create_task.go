...
// WritingCategoryGrantCreateTask creates a new grant for a writing category.
type WritingCategoryGrantCreateTask struct{ tasks.TaskString }

var writingCategoryGrantCreateTask = &WritingCategoryGrantCreateTask{TaskString: TaskWritingCategoryGrantCreate}

var _ tasks.Task = (*WritingCategoryGrantCreateTask)(nil)

func (WritingCategoryGrantCreateTask) Action(w http.ResponseWriter, r *http.Request) any {
