...
<<<<<<< HEAD
=======
	AppendToCommentForPoster(ctx context.Context, arg AppendToCommentForPosterParams) error
	CheckIfOthersReadCommentForPoster(ctx context.Context, arg CheckIfOthersReadCommentForPosterParams) (int32, error)
>>>>>>> 585b27a2 (feat(forum): implement post appending within time window)
...
<<<<<<< HEAD
=======
	GetLastCommentByThreadIdForPoster(ctx context.Context, forumthreadID int32) (*Comment, error)
>>>>>>> 585b27a2 (feat(forum): implement post appending within time window)
