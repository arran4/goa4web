...
func (q *Queries) AdminGetRequest(ctx context.Context, id int64) (*AdminRequestQueue, error) {
...
func (q *Queries) AdminGetRequestByID(ctx context.Context, id int64) (*AdminRequestQueue, error) {
...
func (q *Queries) AdminListRequestsByUserID(ctx context.Context, usersIdusers int64) ([]*AdminRequestQueue, error) {
