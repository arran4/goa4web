...
func (q *Queries) LatestAdminUserComment(ctx context.Context, usersIdusers int64) (*AdminUserComment, error) {
...
func (q *Queries) ListAdminUserComments(ctx context.Context, usersIdusers int64) ([]*AdminUserComment, error) {
