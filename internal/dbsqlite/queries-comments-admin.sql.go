...
func (q *Queries) AdminDeleteCommentsByThread(ctx context.Context, forumthreadID int64) error {
...
func (q *Queries) AdminHardDeleteComment(ctx context.Context, idcomments int64) error {
