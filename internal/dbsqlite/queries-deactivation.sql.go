...
func (q *Queries) AdminArchiveUser(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminGetDeactivatedCommentById(ctx context.Context, idcomments int64) (*DeactivatedComment, error) {
...
func (q *Queries) AdminIsBlogDeactivated(ctx context.Context, idblogs int64) (int64, error) {
	row := q.db.QueryRowContext(ctx, adminIsBlogDeactivated, idblogs)
	var is_deactivated int64
...
func (q *Queries) AdminIsCommentDeactivated(ctx context.Context, idcomments int64) (int64, error) {
...
func (q *Queries) AdminIsImagepostDeactivated(ctx context.Context, idimagepost int64) (int64, error) {
...
func (q *Queries) AdminIsLinkDeactivated(ctx context.Context, id int64) (int64, error) {
...
func (q *Queries) AdminIsUserDeactivated(ctx context.Context, idusers int64) (int64, error) {
...
func (q *Queries) AdminIsWritingDeactivated(ctx context.Context, idwriting int64) (int64, error) {
...
func (q *Queries) AdminMarkBlogRestored(ctx context.Context, idblogs int64) error {
...
func (q *Queries) AdminMarkCommentRestored(ctx context.Context, idcomments int64) error {
...
func (q *Queries) AdminMarkImagepostRestored(ctx context.Context, idimagepost int64) error {
...
func (q *Queries) AdminMarkLinkRestored(ctx context.Context, id int64) error {
...
func (q *Queries) AdminMarkUserRestored(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminMarkWritingRestored(ctx context.Context, idwriting int64) error {
...
func (q *Queries) AdminRestoreUser(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminRestoreUserEmail(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminRestoreUserPassword(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminScrubImagepost(ctx context.Context, idimagepost int64) error {
...
func (q *Queries) AdminScrubUserEmails(ctx context.Context, userID int64) error {
...
func (q *Queries) AdminScrubUserPasswords(ctx context.Context, usersIdusers int64) error {
