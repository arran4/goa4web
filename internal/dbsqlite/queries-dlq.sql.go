...
func (q *Queries) SystemDeleteDeadLetter(ctx context.Context, id int64) error {
...
func (q *Queries) SystemGetDeadLetter(ctx context.Context, id int64) (*DeadLetter, error) {
...
func (q *Queries) SystemListDeadLetters(ctx context.Context, limit int64) ([]*DeadLetter, error) {
