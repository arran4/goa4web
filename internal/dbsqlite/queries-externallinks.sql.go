...
func (q *Queries) AdminDeleteExternalLink(ctx context.Context, id int64) error {
...
func (q *Queries) GetExternalLinkByID(ctx context.Context, id int64) (*ExternalLink, error) {
