...
func (q *Queries) AdminCountLinksByCategory(ctx context.Context, categoryID sql.NullInt64) (int64, error) {
...
INSERT INTO linker_category (title, position) VALUES (?1, ?2)
`
...
func (q *Queries) AdminDeleteLinkerCategory(ctx context.Context, id int64) error {
...
func (q *Queries) AdminDeleteLinkerQueuedItem(ctx context.Context, id int64) error {
...
func (q *Queries) AdminInsertQueuedLinkFromQueue(ctx context.Context, id int64) (int64, error) {
...
WHERE EXISTS (
    ...
    WHERE g.section='linker'
      ...
      AND (g.role_id IS NULL OR g.role_id IN (
          SELECT ur.role_id FROM user_roles ur WHERE ur.users_idusers = ?1
      ))
)
`
...
func (q *Queries) GetAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescending(ctx context.Context, categoryID int64) ([]*GetAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescendingRow, error) {
	rows, err := q.db.QueryContext(ctx, getAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescending, categoryID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescendingForUser(ctx context.Context, arg GetAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescendingForUserParams) ([]*GetAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescendingForUserRow, error) {
	rows, err := q.db.QueryContext(ctx, getAllLinkerItemsByCategoryIdWitherPosterUsernameAndCategoryTitleDescendingForUser, arg.CategoryID, arg.ViewerID, arg.ViewerUserID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetLinkerCategoryById(ctx context.Context, id int64) (*LinkerCategory, error) {
...
func (q *Queries) GetLinkerItemByIdWithPosterUsernameAndCategoryTitleDescending(ctx context.Context, id int64) (*GetLinkerItemByIdWithPosterUsernameAndCategoryTitleDescendingRow, error) {
...
func (q *Queries) GetLinkerItemByIdWithPosterUsernameAndCategoryTitleDescendingForUser(ctx context.Context, arg GetLinkerItemByIdWithPosterUsernameAndCategoryTitleDescendingForUserParams) (*GetLinkerItemByIdWithPosterUsernameAndCategoryTitleDescendingForUserRow, error) {
	row := q.db.QueryRowContext(ctx, getLinkerItemByIdWithPosterUsernameAndCategoryTitleDescendingForUser, arg.ID, arg.ViewerID, arg.ViewerUserID)
...
func (q *Queries) GetLinkerItemsByIdsWithPosterUsernameAndCategoryTitleDescending(ctx context.Context, linkerids []int64) ([]*GetLinkerItemsByIdsWithPosterUsernameAndCategoryTitleDescendingRow, error) {
...
func (q *Queries) ListLinkerCategoryPath(ctx context.Context, categoryID int64) ([]*ListLinkerCategoryPathRow, error) {
