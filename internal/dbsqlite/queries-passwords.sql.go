...
func (q *Queries) DeletePendingPassword(ctx context.Context, userID int64) error {
...
func (q *Queries) GetPendingPassword(ctx context.Context, userID int64) (*PendingPassword, error) {
