...
// admin task
func (q *Queries) AdminGetRoleByID(ctx context.Context, id int64) (*Role, error) {
...
// admin task
func (q *Queries) AdminListGrantsByRoleID(ctx context.Context, roleID sql.NullInt64) ([]*Grant, error) {
...
// admin task
func (q *Queries) AdminListUsersByRoleID(ctx context.Context, roleID int64) ([]*AdminListUsersByRoleIDRow, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(&i.IduserRoles, &i.Idusers, &i.Username); err != nil {
			return nil, err
		}
		items = append(items, &i)
	}
...
func (q *Queries) DeleteGrantsByRoleID(ctx context.Context, roleID sql.NullInt64) error {
...
func (q *Queries) GetGrantsByRoleID(ctx context.Context, roleID sql.NullInt64) ([]*Grant, error) {
