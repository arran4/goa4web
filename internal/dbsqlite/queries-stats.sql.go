...
func (q *Queries) AdminCountThreadsByBoard(ctx context.Context, imageboardIdimageboard sql.NullInt64) (int64, error) {
...
func (q *Queries) AdminGetRecentAuditLogs(ctx context.Context, limit int64) ([]*AdminGetRecentAuditLogsRow, error) {
...
func (q *Queries) AdminUserPostCountsByID(ctx context.Context, idusers int64) (*AdminUserPostCountsByIDRow, error) {
