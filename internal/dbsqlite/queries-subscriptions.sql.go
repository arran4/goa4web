...
DELETE FROM subscriptions WHERE users_idusers = ?1 AND id = ?2
`
...
WHERE users_idusers = ?1 AND pattern = ?2 AND method = ?3
`
...
func (q *Queries) ListSubscribersForPattern(ctx context.Context, arg ListSubscribersForPatternParams) ([]int64, error) {
...
func (q *Queries) ListSubscribersForPatterns(ctx context.Context, arg ListSubscribersForPatternsParams) ([]int64, error) {
...
func (q *Queries) ListSubscriptionsByUser(ctx context.Context, usersIdusers int64) ([]*ListSubscriptionsByUserRow, error) {
...
func (q *Queries) ListThreadSubscriptionsByUser(ctx context.Context, usersIdusers int64) ([]*ListThreadSubscriptionsByUserRow, error) {
...
UPDATE subscriptions SET pattern = ?1, method = ?2
WHERE users_idusers = ?3 AND id = ?4
`
