...
func (q *Queries) AdminDeleteUserEmail(ctx context.Context, id int64) error {
...
func (q *Queries) AdminGetUserEmailByID(ctx context.Context, id int64) (*UserEmail, error) {
...
func (q *Queries) AdminListUserEmails(ctx context.Context, userID int64) ([]*UserEmail, error) {
...
func (q *Queries) GetMaxNotificationPriority(ctx context.Context, userID int64) (interface{}, error) {
...
func (q *Queries) GetNotificationEmailByUserID(ctx context.Context, userID int64) (*UserEmail, error) {
...
func (q *Queries) ListUserEmailsForLister(ctx context.Context, arg ListUserEmailsForListerParams) ([]*UserEmail, error) {
	rows, err := q.db.QueryContext(ctx, listUserEmailsForLister, arg.UserID, arg.ListerID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
UPDATE user_emails SET notification_priority = ?1
...
DELETE FROM user_emails WHERE email = ?1 AND id != ?2
`
...
func (q *Queries) SystemListVerifiedEmailsByUserID(ctx context.Context, userID int64) ([]*UserEmail, error) {
