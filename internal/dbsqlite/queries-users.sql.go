...
func (q *Queries) AdminDeleteUserByID(ctx context.Context, idusers int64) error {
...
func (q *Queries) AdminListAllUserIDs(ctx context.Context) ([]int64, error) {
...
func (q *Queries) AdminListUserIDsByRole(ctx context.Context, name string) ([]int64, error) {
...
func (q *Queries) AdminListUsersByID(ctx context.Context, ids []int64) ([]*AdminListUsersByIDRow, error) {
...
func (q *Queries) CheckUserHasGrant(ctx context.Context, arg CheckUserHasGrantParams) (int64, error) {
...
func (q *Queries) SystemGetUserByID(ctx context.Context, idusers int64) (*SystemGetUserByIDRow, error) {
...
func (q *Queries) SystemGetUsersByIDs(ctx context.Context, ids []int64) ([]*SystemGetUsersByIDsRow, error) {
...
UPDATE users SET public_profile_enabled_at = ?1
WHERE idusers = ?2
  AND EXISTS (
...
func (q *Queries) UpdatePublicProfileEnabledAtForUser(ctx context.Context, arg UpdatePublicProfileEnabledAtForUserParams) error {
	_, err := q.db.ExecContext(ctx, updatePublicProfileEnabledAtForUser, arg.EnabledAt, arg.UserID, arg.GranteeID)
	return err
}
