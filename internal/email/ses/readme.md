...
- `ses_stub.go`: Contains implementations and definitions related to the specific operations of this module.
- `ses.go`: Contains implementations and definitions related to the specific operations of this module.
