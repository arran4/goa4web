...
func (n Notifier) NotifyChange(ctx context.Context, userID int32, emailAddr, page string) error {
	if err := emailutil.NotifyChange(ctx, n.Provider, emailAddr, page); err != nil {
		return err
	}
...
func (n Notifier) NotifyAdmins(ctx context.Context, page string) {
	emailutil.NotifyAdmins(ctx, n.Provider, n.Queries, page)
...
func (n Notifier) NotifyThreadSubscribers(ctx context.Context, threadID, excludeUser int32, page string) {
	emailutil.NotifyThreadSubscribers(ctx, n.Provider, n.Queries, threadID, excludeUser, page)
	if n.Queries == nil || !common.NotificationsEnabled() {
		return
	}
