...
func main() {
	...
	ar.HandleFunc("/users", adminUsersHandler).Methods("GET")
	ar.HandleFunc("/users", adminUsersDoNothingHandler).Methods("POST").MatcherFunc(taskMatcher("User do nothing"))
	ar.HandleFunc("/users/permissions", adminUsersPermissionsHandler).Methods("GET")
	ar.HandleFunc("/users/permissions", adminUsersPermissionsUserAllowHandler).Methods("POST").MatcherFunc(taskMatcher("User Allow"))
	ar.HandleFunc("/users/permissions", adminUsersPermissionsDisallowHandler).Methods("POST").MatcherFunc(taskMatcher("User Disallow"))
	ar.HandleFunc("/languages", adminLanguagesHandler).Methods("GET")
