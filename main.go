...
func main() {
	...
	fr.HandleFunc("/admin/category/{category}/edit", forumAdminCategoriesEditPage).Methods("POST").MatcherFunc(RequiredAccess("administrator")).MatcherFunc(TaskMatcher("Forum category change"))
