...
func main() {
	...
	fr.HandleFunc("/admin", forumPage).Methods("GET")
	fr.HandleFunc("/admin/categories", forumPage).Methods("GET")
	fr.HandleFunc("/admin/categories/create", forumPage).Methods("GET")
	fr.HandleFunc("/admin/topics", forumPage).Methods("GET")
	fr.HandleFunc("/admin/user", forumPage).Methods("GET")
	fr.HandleFunc("/admin/restrictions", forumPage).Methods("GET")
	fr.HandleFunc("/admin/restrictions/users", forumPage).Methods("GET")
	fr.HandleFunc("/admin/restrictions/user/{user}", forumPage).Methods("GET")
	fr.HandleFunc("/category/%s", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s/new", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s/thread/%s", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s/thread/%s/reply", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s/thread/%s/reply", forumPage).Methods("POST").MatcherFunc(TaskMatcher("Reply"))
	fr.HandleFunc("/topic/%s/thread/%s/edit", forumPage).Methods("GET")
	fr.HandleFunc("/topic/%s/thread/%s/edit", forumPage).Methods("POST").MatcherFunc(TaskMatcher("Edit Post"))
