...
func newRouter(cfg RuntimeConfig) http.Handler {
	r := mux.NewRouter()
...
func addNewsRoutes(r *mux.Router) {
...
func addBlogRoutes(r *mux.Router) *mux.Router {
...
func addImageBBSRoutes(r *mux.Router) *mux.Router {
...
func addAdminRoutes(r *mux.Router, br, ibr *mux.Router) {
