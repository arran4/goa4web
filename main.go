...
func main() {
	...
	/*TODO*/ fr.HandleFunc("/topic/{topic}/thread/{thread}/reply", forumTopicThreadReplyPage).Methods("GET")
	fr.HandleFunc("/topic/{topic}/thread/{thread}/reply", taskDoneAutoRefreshPage).Methods("POST")
