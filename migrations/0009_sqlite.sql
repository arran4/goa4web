-- +goose Up
ALTER TABLE writing ADD COLUMN deleted_at DATETIME DEFAULT NULL;
ALTER TABLE blogs ADD COLUMN deleted_at DATETIME DEFAULT NULL;
ALTER TABLE imagepost ADD COLUMN deleted_at DATETIME DEFAULT NULL;
ALTER TABLE linker ADD COLUMN deleted_at DATETIME DEFAULT NULL;
