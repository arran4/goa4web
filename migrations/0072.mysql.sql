-- Role: news reader
-- Description: News reader role with access to read news.
INSERT INTO roles (name, can_login, is_admin) VALUES ('news reader', 0, 0)
...
INSERT INTO schema_version (version) VALUES (72) ON DUPLICATE KEY UPDATE version = VALUES(version);
