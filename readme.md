...
Optional notification emails are sent through [AWS SES](https://aws.amazon.com/ses/). The template for these messages lives under `core/templates/email/updateEmail.txt`.
