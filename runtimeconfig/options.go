...
type StringOption struct {
	...
	Usage   string
	Default string
	// ExtendedUsage is the name of an embedded template file providing
	// additional help text for the option.
...
var StringOptions = []StringOption{
	{"db-conn", config.EnvDBConn, "DBConn", "database connection string", "", "db_conn.txt"},
	{"db-driver", config.EnvDBDriver, "DBDriver", "database driver", "mysql", "db_driver.txt"},
